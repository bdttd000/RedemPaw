...
<body>
    ...
    <main>
        <div class="container white-text">
            <h3>
                Jeśli masz jakiekolwiek pytania, wątpliwości lub sugestie dotyczące naszej strony "RedemPAW" lub
                chciałbyś
            ...
            <ul>
                <li>Adres: RedemPAW Inc., ul. Przykładowa 123, 00-000 Miasto, Kraj</li>
                <li>Adres e-mail: info@redempaw.com</li>
            ...
            <h3>
                Dziękujemy za zainteresowanie stroną "RedemPAW" i czekamy na Twoją wiadomość. Postaramy się jak
                najlepiej
