    ...
    <main>
        <div class="container white-text">
            <h2>
                ...
                użytkowników
                na
                stronie "RedemPAW". Dbamy o prywatność naszych użytkowników i zobowiązujemy się do zapewnienia
                bezpieczeństwa
                ich
            ...
            <ul>
                <li>
                    1.1. Podczas rejestracji konta i korzystania z naszej strony "RedemPAW", możemy zbierać pewne dane
                    osobowe,
                    takie
            ...
            <ul>
                <li>
                    ...
                    z
                    funkcji
                    strony "RedemPAW" oraz do prowadzenia działań marketingowych i promocyjnych.
                </li>
                <li>
