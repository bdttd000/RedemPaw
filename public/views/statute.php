...
<body>
    ...
    <main>
        <div class="container white-text">
            <h2>
                Witamy na stronie internetowej "RedemPAW" - platformie, która pomaga w publikowaniu zwierząt gotowych na
            ...
            <h3>Rejestracja</h3>
            <ul>
                <li>1.1. Aby korzystać z pełnej funkcjonalności strony "RedemPAW", musisz założyć konto. Wszystkie
            ...
            <ul>
                <li>2.1. Tylko zwierzęta gotowe na adopcję mogą być publikowane na stronie "RedemPAW". Zwierzęta muszą
                ...
                <li>2.5. RedemPAW zastrzega sobie prawo do usunięcia ogłoszeń, które naruszają regulamin lub przepisy
            ...
            <ul>
                <li>3.1. Wszelkie transakcje, negocjacje i interakcje między użytkownikami są ich wyłączną
                    odpowiedzialnością. RedemPAW nie ponosi odpowiedzialności za ewentualne szkody, straty lub
